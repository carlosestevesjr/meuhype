...
class CronJobController extends Controller
{
  ...
  public function buscaMatandoRobosGigantesYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-matandorobosgigantesyoutube')],
        [
  ...
  public function buscaThiagoRomarizYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-thiagoromarizyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaEntreMigasYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-entremigasyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaMiguelLokiaYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-miguellokiayoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaGustavoCunhaYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-gustavocunhayoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNerdNewsYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-nerdnewsyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaSessaoNerdYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-sessaonerdyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaArenaNerdYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-arenanerdyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaCaldeiraoNerdYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-caldeiraonerdyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNerdExperienceYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-nerdexperienceyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaCrisPandaYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-crispandayoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNerdRabugentoYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-nerdrabugentoyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaOperacaoCinemaYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-operacaocinemayoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaQuatroCoisasYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-quatrocoisasyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaCavernaDoCarusoYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-cavernadocarusoyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaCaiqueIzotonYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-caiqueizotonyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaCinemaComRapaduraYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-cinemacomrapadurayoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsNerdLandYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-nerdlandyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsEiNerdYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-einerdyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsPipocandoYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-pipocandoyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsOmeleteYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-omeleteyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsJovemNerdYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-jovemnerdyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsSuperOitoYoutube()
  {
    ...
    foreach ($dados_busca as $item) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($item['noticia'] . '-superoitoyoutube')],
        [
          'hash' => 'required|unique:news',
        ],
        $messages = [
  ...
  public function buscaNewsJovemNerdSite()
  {
    ...
    if (count($return['content']) > 0) {
      foreach ($return['content'] as $item) {
        ...
        //Validando os campos
        $validator = Validator::make(
          ['hash' => Str::slug($item['noticia'] . '-jovemnerdsite')],
          [
            'hash' => 'required|unique:news',
          ],
          $messages = [
  ...
  public function buscaNewsOmeleteSite()
  {
    ...
    if (count($return['content']) > 0) {
      foreach ($return['content'] as $item) {
        ...
        //Validando os campos
        $validator = Validator::make(
          ['hash' => Str::slug($item['noticia'][0] . '-omeletesite')],
          [
            'hash' => 'required|unique:news',
          ],
          $messages = [
  ...
  public function buscaTecMundoSite()
  {
    ...
    if (count($return['content']) > 0) {
      foreach ($return['content'] as $item) {
        ...
        //Validando os campos
        $validator = Validator::make(
          ['hash' => Str::slug($item['noticia'] . '-tecmundosite')],
          [
            'hash' => 'required|unique:news',
          ],
          $messages = [
  ...
  public function buscaPoltronaNerdSite()
  {
    ...
    if (count($return['content']) > 0) {
      foreach ($return['content'] as $item) {
        ...
        //Validando os campos
        $validator = Validator::make(
          ['hash' => Str::slug($item['noticia'] . '-poltronanerdsite')],
          [
            'hash' => 'required|unique:news',
          ],
          $messages = [
  ...
  public function buscaNewsCinemaComRapaduraSpotify()
  {
    ...
    foreach ($podcasts['episodes']['items'] as $key => $podcast) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($podcast['name'] . '-cinema-com-rapadura-spotify')],
        [
  ...
  public function buscaNewsJovemNerdSpotify()
  {
    ...
    foreach ($podcasts['episodes']['items'] as $key => $podcast) {
      ...
      //Validando os campos
      $validator = Validator::make(
        ['hash' => Str::slug($podcast['name'] . '-jovemnerd-spotify')],
        [
          'hash' => 'required|unique:podcasts',
        ],
        $messages = [
  ...
  public function downloadFile($imgName, $url, $path)
  {
    ...
    $image->resizeToWidth(268);
    $return = $image->save($path. $imgName);
    return $return;
  }
  ...
  function resize()
  {
    $news = News::where('image', '!=', '')->get();
    foreach ($news as $key => $item) {
        echo $key . ' ' . $item->image;
        if(!file_exists(public_path($item->image))) continue;
        
        $image = new ImageResize(public_path($item->image));
        // $image->scale(50);
        $image->resizeToWidth(268);
        $image->save(public_path($item->image));
