                ...
                <form method="post" action="{{ URL::asset( $prefix_admin.'/'.$page_dados['route_controler']) }}" role="form" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-12">
                                <label>Hash</label>
                                <input type="text" name="hash" class="form-control" placeholder="" value="{{ old('hash') }}" >
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>Twitter</label>
                                <input type="text" name="twitter" class="form-control" placeholder="" value="{{ old('twitter') }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>Youtube</label>
                                <input type="text" name="youtube" class="form-control" placeholder="" value="{{ old('youtube') }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" name="url_crawler" class="form-control" placeholder="" value="{{ old('url_crawler') }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
