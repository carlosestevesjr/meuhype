                    ...
                    <form method="post" action="{{ URL::asset($prefix_admin.'/'.$page_dados['route_controler'].'/'.$item->id ) }}" role="form" class="form" enctype="multipart/form-data" >
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-12">
                                ...
                                <textarea name="description_short" id="description_short" class="form-control" maxlength="255" rows="3">{{ $item->description_short }}</textarea>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>Link</label>
                                <input type="text" name="link" class="form-control" placeholder="" value="{{ $item->link }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>Twitter</label>
                                <input type="text" name="twitter" class="form-control" placeholder="" value="{{ $item->twitter }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>Youtube</label>
                                <input type="text" name="youtube" class="form-control" placeholder="" value="{{ $item->youtube }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                <label>URL Crawler</label>
                                <input type="text" name="url_crawler" class="form-control" placeholder="" value="{{ $item->url_crawler }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
