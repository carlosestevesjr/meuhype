                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" name="time_initial" class="form-control" placeholder="" readonly value="{{ $item->time_initial }}" >
                            </div>
                            <div class="form-group col-12 col-lg-6">
                                <label>Hora Final</label>
                                <input type="text" name="time _final" class="form-control" placeholder="" readonly value="{{ $item->time _final }}" >
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 col-lg-12">
