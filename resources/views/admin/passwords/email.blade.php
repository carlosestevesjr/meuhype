                ...
                <div class="auth-container">
                    <div class="card">
                        ...
                        <div class="auth-content">
                            <p class="text-xs-center">Email para recuperar senha</p>
                            @if (session('status'))
                                <div class="alert alert-success">
                                    {{ session('status') }}
                                </div>
                            @endif
                            <form class="form-horizontal" role="form" method="POST" action="{{ url($prefix_admin.'/password/email') }}">
                                ...
                                <div class="form-group">
                                    {{ csrf_field() }}
                                    <button type="submit" class="btn btn-primary">Enviar email de recuperação de senha</button>
                                </div>
                            </form>
                        </div>
                    </div>
